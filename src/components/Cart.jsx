...
function Cart() {
  const {currentColor, isActiveMenu, setIsActiveMenu, shopCart, setShopCart} = useStateContext();
  return (
    
   

  
    <div className='b-half-transparent w-full fixed nav-item top-0 right-0'>
...
<div className='float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8'>
        <div className='flex justify-between items-center'>
          ...
          onClick={()=>setShopCart(prevState =>!prevState)}
